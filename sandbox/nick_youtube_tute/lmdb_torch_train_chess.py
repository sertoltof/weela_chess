...
class LMDBDataset(Dataset):
    def __init__(self, lmdb_path,
        ...
        with self.env.begin(write=False) as txn:
            self.keys = [f"example_{i}".encode() for i in range(txn.stat()["entries"])]
...
train_dataset = LMDBDataset("/home/gerk/sts_after_images/lichess_elite_lmdb/lichess_elite", is_train=True, train_split_pct=0.1, transform=prepare_data)
test_dataset = LMDBDataset("/home/gerk/sts_after_images/lichess_elite_lmdb/lichess_elite", is_train=False, train_split_pct=0.1, transform=prepare_data)
